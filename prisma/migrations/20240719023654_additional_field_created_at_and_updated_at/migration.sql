/*
  ...
  - Added the required column `addressData` to the `orders` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "addressData" JSONB NOT NULL,
